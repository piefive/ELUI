...
import { useFirstMountState, useForkForwardedRef, usePrevious } from 'lib';
...
export const CheckboxInput = forwardRef<HTMLInputElement, ICheckboxInput>(({ checked, ...rest }, inputRef) => {
  ...
  return (
    <StyledCheckboxInput className={CHECKBOX_INPUT_CN}>
